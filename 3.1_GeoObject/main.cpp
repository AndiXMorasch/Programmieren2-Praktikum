...
// #include "Punkt.hpp"             --> Auskommentiert, da ich angezeigt bekomme, dass er die files nicht findet!
// #include "GeoObjekt.hpp"         --> Auskommentiert, da ich angezeigt bekomme, dass er die files nicht findet!
#include "Rechteck.h"
#include "Kreis.h"
#include "Quader.h"
#include "Ball.h"
...
int main() {
    ...
    // Speicher freigeben (geklonte Objekte)
    delete pGeoR2;
    delete pGeoK2;
    delete pGeoQ2;
    delete pGeoB2;
